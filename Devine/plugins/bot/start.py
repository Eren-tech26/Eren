...
async def start_pm(client, message: Message, _):
    ...
    started_msg = await message.reply_text(text="<b>sᴛᴀʀᴛᴇᴅ...<a href='https://i.ibb.co/rf5HWY5F/photo-2025-08-30-17-35-40-7544433638260080648.jpg' target='_blank'>ㅤ ㅤㅤㅤ</a></b>")
    ...
    if len(message.text.split()) > 1:
        ...
        if name.startswith("help"):
            ...
            await message.reply_text(
                text=(
                    f"<b>ʜᴇʏ {message.from_user.mention}, <a href='https://i.ibb.co/rf5HWY5F/photo-2025-08-30-17-35-40-7544433638260080648.jpg' target='_blank'>✨️🕊</a></b>\n\n"
        ...
        await message.reply_text(
            text=(
                 f"<b>ʏᴏᴏ {message.from_user.mention}, <a href='https://i.ibb.co/rf5HWY5F/photo-2025-08-30-17-35-40-7544433638260080648.jpg' target='_blank'>✨️🕊</a></b>\n\n"
                 f"<b>ᴛʜɪs ɪs {app.mention}, ᴇʟᴇᴠᴀᴛᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴠɪᴅᴇᴏ ᴄʜᴀᴛ ᴡɪᴛʜ ᴛʜɪs ᴀᴡᴇsᴏᴍᴇ ᴛᴇʟᴇɢʀᴀᴍ ᴍᴜsɪᴄ ʙᴏᴛ.</b>\n\n"
